    ...
    public boolean onTouchThisEvent(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                if (direction == Gravity.LEFT) {
                    if (slideX > 200) {
                        ObjectAnimator translationX = ObjectAnimator.ofFloat(this, "translationX", -slideX, -PEPDialogAnimate.getScreenWidth(this.getContext())).setDuration(300);
                ...
                if (direction == Gravity.TOP) {
                    if (slideY >= 0) {
                        ...
                        if (slideY > -200) {
                            ...
                            ViewHelper.setY(this, -slideY);
                            ObjectAnimator translationY = ObjectAnimator.ofFloat(this, "translationY", -slideY, PEPDialogAnimate.getScreenHeight(this.getContext())).setDuration(300);
